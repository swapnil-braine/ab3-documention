...
| **OrganizationUser** | **User**               | 1:1 (invitedBy)         | `OrganizationUser.invitedBy` → `User._id`                                                  | DB                          | `organizationUser.model.ts:45-48`                                    |
| **TeamUser**         | **User**               | 1:1 (invitedBy)         | `TeamUser.invitedBy` → `User._id`                                                          | DB                          | `teamUser.model.ts:27-30`                                            |
